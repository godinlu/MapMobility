...
def get_grid_time(force = 0):
    if not(os.path.exists('./data/Distances_points_gares.csv')) or (force == 1):
        ...
        return pd.read_csv('./data/Distances_points_gares.csv')
